...
public class TodoViewCompleted {
    String projpath;
	WebDriver driver;
	JavascriptExecutor js;
	@Given("User is on Todos management screen to view completed")
	public void User_is_on_Todos_management_screen_to_view_completed() {
	...
	public void User_creates_the_Todos_and_hit_the_Enter_button_and_change_the_status_of_Todos_to_completed_and_Click_on_Completed_button() throws InterruptedException , IOException
	{
	...
	public void Completed_Todos_are_listed_as_green_tick_items_in_the_Todos_list() {
		//System.out.println("on Todo screen");
		  js.executeScript("alert('Completed Todos are listed as green tick items in the Todos list');");   
	}
}
